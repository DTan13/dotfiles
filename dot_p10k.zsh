# Generated by Powerlevel10k configuration wizard on 2021-08-23 at 21:19 IST.
...
() {
  ...
  function prompt_network () {
    local connection_status=""
    local all_devices="$(nmcli d s | grep -v 'externally' | grep -w 'connected' | awk {'print $2'})"
    local connection_device="$(echo $all_devices | grep -o wifi) $(echo $all_devices | grep -o ethernet)"
    ...
    p10k segment -b 249 -f 129 -i $connection_status -t "$connection_device"
  }

  function prompt_os(){
    os=$(lsb_release -d | grep 'Descr'|awk {'print $2" "$3'})
    p10k segment -b 232 -f 40 -t $os
  }
